...
| #6 | ONNX Runtime CPU pipeline, verified model manifest/hash/licence gates, parser and sidecar fallback | Unit tests, fake-runtime OCR integration tests, official model hashes | CPU OCR on private screenshot ground truth remains unperformed |
