...
| #10 | CPU default, DXGI-ordered DirectML adapter enumeration, unavailable-adapter explanations and no silent fallback | Current machine enumerated Intel Iris Xe as DXGI adapter 0, RTX 4050 as adapter 1, and disabled Microsoft Basic Render Driver; both hardware adapters completed `288376_0.jpg`; RTX adapter 1 matched CPU classification, ranks, and scores | One real screenshot is not broad OCR parity; additional samples remain under #7 |
